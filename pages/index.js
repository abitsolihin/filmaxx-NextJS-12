        ...
        <nav className="max-w-[1980px] mx-auto h-[60px] flex  z-50 absolute right-0 left-0">
          ...
          <div className="right hidden sm:flex w-full">
            <div className="navlist w-[80%] lg:w-[85%] text-white flex items-center justify-end text-sm gap-4">
              <Link href="/">
                <a className=" py-5 relative after:content-[''] after:bottom-0 after:h-[2px] hover:after:w-full after:w-0 after:absolute after:bg-red-600 flex flex-col justify-center items-center after:duration-200">Daftar Film</a>
              </Link>
              <Link href="/">
                <a className=" py-5 relative after:content-[''] after:bottom-0 after:h-[2px] hover:after:w-full after:w-0 after:absolute after:bg-red-600 flex flex-col justify-center items-center after:duration-200">Genre</a>
              </Link>
              <Link href="/">
                <a className=" py-5 relative after:content-[''] after:bottom-0 after:h-[2px] hover:after:w-full after:w-0 after:absolute after:bg-red-600 flex flex-col justify-center items-center after:duration-200">Baru Rilis</a>
              </Link>
            </div>
            <div className="button w-[20%] lg:w-[15%] text-white flex items-center justify-center">
              <Link href="/">
                <a className="hover:bg-red-600 border-2 border-solid border-red-600 duration-200 px-3 text-sm py-1 rounded">Sign In</a>
              </Link>
            </div>
          </div>
        </nav>
                ...
                films.map((film) => (
                  <SplideSlide className="card duration-200 w-full h-[70%] md:h-[250px] 2xl:h-[380px] bg-gray-600/25 rounded-xl backdrop-blur-xl flex items-center justify-center" key={film.id}>
                    ...
                    <div className="img-wrapper w-[40%] h-[170px] md:h-[200px] lg:h-full flex justify-center p-4">
                      <div style={{ backgroundImage: `url(${film.url})` }} className="rounded-xl w-full h-full bg-cover"></div>
                    </div>
                  </SplideSlide>
                ))}
            </Splide>
          ...
          <div className="section h-[40vh] text-white ">
            <div className="title-wrapper flex p-4">
              ...
              <div className="genre w-3/6 flex justify-end gap-2 xl:gap-8 text-xs 2xl:text-xl items-center">
                <Link href="">
                  <a className="text-xs xl:text-base py-1 relative after:content-[''] after:bottom-0 after:h-[2px] hover:after:w-full after:w-0 after:absolute after:bg-red-600 flex flex-col justify-center items-center after:duration-200">
                    Aksi
                  </a>
                </Link>
                <Link href="">
